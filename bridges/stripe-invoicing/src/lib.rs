...
//! `invoicekit-bridge-stripe-invoicing` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_bridge_stripe_invoicing::crate_name(), "invoicekit-bridge-stripe-invoicing");
/// ```
#[must_use]
