...
//! `invoicekit-report-th-rd` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_th_rd::crate_name(), "invoicekit-report-th-rd");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-th-rd");
    }
