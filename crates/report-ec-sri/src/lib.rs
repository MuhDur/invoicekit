...
//! `invoicekit-report-ec-sri` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_ec_sri::crate_name(), "invoicekit-report-ec-sri");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-ec-sri");
    }
