...
//! `invoicekit-report-cn-fapiao` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_cn_fapiao::crate_name(), "invoicekit-report-cn-fapiao");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-cn-fapiao");
    }
