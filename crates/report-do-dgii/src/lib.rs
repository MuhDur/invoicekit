//! `invoicekit-report-do-dgii` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_do_dgii::crate_name(), "invoicekit-report-do-dgii");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-do-dgii");
    }
