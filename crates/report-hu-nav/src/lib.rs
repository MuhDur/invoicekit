...
//! `invoicekit-report-hu-nav` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_hu_nav::crate_name(), "invoicekit-report-hu-nav");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-hu-nav");
    }
