...
//! `invoicekit-report-pe-sunat` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_pe_sunat::crate_name(), "invoicekit-report-pe-sunat");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-pe-sunat");
    }
