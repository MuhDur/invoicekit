//! `invoicekit-report-ph-bir` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_ph_bir::crate_name(), "invoicekit-report-ph-bir");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-ph-bir");
    }
