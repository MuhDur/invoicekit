...
//! `invoicekit-report-ke-etims` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_ke_etims::crate_name(), "invoicekit-report-ke-etims");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-ke-etims");
    }
