...
fn main() -> ExitCode {
    ...
    match sub.as_str() {
        ...
        "diff" => invoicekit_cli::commands::diff::run(&rest),
        "doctor" => invoicekit_cli::commands::doctor::run(&rest),
        "migrate-archive" => invoicekit_cli::commands::migrate_archive::run(&rest),
        "pack" => invoicekit_cli::commands::pack::run(&rest),
        "unpack" => invoicekit_cli::commands::unpack::run(&rest),
        "show" => invoicekit_cli::commands::show::run(&rest),
