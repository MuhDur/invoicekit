//! `invoicekit-report-id-djp` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_id_djp::crate_name(), "invoicekit-report-id-djp");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-id-djp");
    }
