...
//! `invoicekit-report-ar-afip` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_ar_afip::crate_name(), "invoicekit-report-ar-afip");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-ar-afip");
    }
