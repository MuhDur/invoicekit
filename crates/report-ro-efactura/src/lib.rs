//! `invoicekit-report-ro-efactura` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_ro_efactura::crate_name(), "invoicekit-report-ro-efactura");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-ro-efactura");
    }
