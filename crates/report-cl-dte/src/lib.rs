...
//! `invoicekit-report-cl-dte` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_cl_dte::crate_name(), "invoicekit-report-cl-dte");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-cl-dte");
    }
