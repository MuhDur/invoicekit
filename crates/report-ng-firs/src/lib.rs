//! `invoicekit-report-ng-firs` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_ng_firs::crate_name(), "invoicekit-report-ng-firs");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-ng-firs");
    }
