//! `invoicekit-report-tr-efatura` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_tr_efatura::crate_name(), "invoicekit-report-tr-efatura");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-tr-efatura");
    }
