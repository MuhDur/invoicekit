//! `invoicekit-report-tw-mof` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_tw_mof::crate_name(), "invoicekit-report-tw-mof");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-tw-mof");
    }
