//! `invoicekit-report-co-dian` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_co_dian::crate_name(), "invoicekit-report-co-dian");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-co-dian");
    }
