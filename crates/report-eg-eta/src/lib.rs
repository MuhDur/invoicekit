//! `invoicekit-report-eg-eta` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_eg_eta::crate_name(), "invoicekit-report-eg-eta");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-eg-eta");
    }
