...
//! `invoicekit-report-kr-nts` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_kr_nts::crate_name(), "invoicekit-report-kr-nts");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-kr-nts");
    }
