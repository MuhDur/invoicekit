...
//! `invoicekit-transmit-email` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_transmit_email::crate_name(), "invoicekit-transmit-email");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-transmit-email");
    }
