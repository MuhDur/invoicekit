...
pub const INVOICE_ELEMENT_COVERAGE: &[UblElementCoverage] = &[
    ...
    row_i("cbc:CopyIndicator", "0..1", UblCoverageClass::UnsupportedGap, "No current IR field; needs explicit copy/original semantics before validation claims include it."),
    ...
    row_i("cbc:IssueTime", "0..1", UblCoverageClass::UnsupportedGap, "No current date-time field in core IR."),
    ...
    row_i("cbc:TaxCurrencyCode", "0..1", UblCoverageClass::UnsupportedGap, "Multi-currency tax reporting is not in core IR yet."),
    row_i("cbc:PricingCurrencyCode", "0..1", UblCoverageClass::UnsupportedGap, "Multi-currency pricing is not in core IR yet."),
    row_i("cbc:PaymentCurrencyCode", "0..1", UblCoverageClass::UnsupportedGap, "Payment-currency separation is not in core IR yet."),
    row_i("cbc:PaymentAlternativeCurrencyCode", "0..1", UblCoverageClass::UnsupportedGap, "Alternative payment currency is not in core IR yet."),
    ...
    row_i("cbc:LineCountNumeric", "0..1", UblCoverageClass::UnsupportedGap, "Derived check value; validation can compare against lines.len() once schema harness lands."),
    ...
    row_i("cac:Signature", "0..unbounded", UblCoverageClass::UnsupportedGap, "Signature handling belongs to signing/evidence tasks, not the core parser."),
    ...
    row_i("cac:TaxExchangeRate", "0..1", UblCoverageClass::UnsupportedGap, "Exchange-rate model is not in core IR yet."),
    row_i("cac:PricingExchangeRate", "0..1", UblCoverageClass::UnsupportedGap, "Exchange-rate model is not in core IR yet."),
    row_i("cac:PaymentExchangeRate", "0..1", UblCoverageClass::UnsupportedGap, "Exchange-rate model is not in core IR yet."),
    row_i("cac:PaymentAlternativeExchangeRate", "0..1", UblCoverageClass::UnsupportedGap, "Exchange-rate model is not in core IR yet."),
    ...
    row_i("cac:WithholdingTaxTotal", "0..unbounded", UblCoverageClass::UnsupportedGap, "Withholding tax is not in core IR yet."),
...
pub const CREDIT_NOTE_ELEMENT_COVERAGE: &[UblElementCoverage] = &[
    ...
    row_c("cbc:CopyIndicator", "0..1", UblCoverageClass::UnsupportedGap, "No current IR field; needs explicit copy/original semantics before validation claims include it."),
    ...
    row_c("cbc:IssueTime", "0..1", UblCoverageClass::UnsupportedGap, "No current date-time field in core IR."),
    ...
    row_c("cbc:TaxCurrencyCode", "0..1", UblCoverageClass::UnsupportedGap, "Multi-currency tax reporting is not in core IR yet."),
    row_c("cbc:PricingCurrencyCode", "0..1", UblCoverageClass::UnsupportedGap, "Multi-currency pricing is not in core IR yet."),
    row_c("cbc:PaymentCurrencyCode", "0..1", UblCoverageClass::UnsupportedGap, "Payment-currency separation is not in core IR yet."),
    row_c("cbc:PaymentAlternativeCurrencyCode", "0..1", UblCoverageClass::UnsupportedGap, "Alternative payment currency is not in core IR yet."),
    ...
    row_c("cbc:LineCountNumeric", "0..1", UblCoverageClass::UnsupportedGap, "Derived check value; validation can compare against lines.len() once schema harness lands."),
    ...
    row_c("cac:Signature", "0..unbounded", UblCoverageClass::UnsupportedGap, "Signature handling belongs to signing/evidence tasks, not the core parser."),
    ...
    row_c("cac:TaxExchangeRate", "0..1", UblCoverageClass::UnsupportedGap, "Exchange-rate model is not in core IR yet."),
    row_c("cac:PricingExchangeRate", "0..1", UblCoverageClass::UnsupportedGap, "Exchange-rate model is not in core IR yet."),
    row_c("cac:PaymentExchangeRate", "0..1", UblCoverageClass::UnsupportedGap, "Exchange-rate model is not in core IR yet."),
    row_c("cac:PaymentAlternativeExchangeRate", "0..1", UblCoverageClass::UnsupportedGap, "Exchange-rate model is not in core IR yet."),
