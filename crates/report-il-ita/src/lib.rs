//! `invoicekit-report-il-ita` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_il_ita::crate_name(), "invoicekit-report-il-ita");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-il-ita");
    }
