...
//! `invoicekit-report-vn-gdt` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_vn_gdt::crate_name(), "invoicekit-report-vn-gdt");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-vn-gdt");
    }
