//! `invoicekit-report-in-gst` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_in_gst::crate_name(), "invoicekit-report-in-gst");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-in-gst");
    }
