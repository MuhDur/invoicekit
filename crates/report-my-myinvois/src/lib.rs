//! `invoicekit-report-my-myinvois` — InvoiceKit workspace member.
//!
...
///
/// ```
/// assert_eq!(invoicekit_report_my_myinvois::crate_name(), "invoicekit-report-my-myinvois");
/// ```
#[must_use]
...
mod tests {
    ...
    fn crate_name_is_cargo_package_name() {
        assert_eq!(crate_name(), "invoicekit-report-my-myinvois");
    }
