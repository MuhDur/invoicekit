...
#
# T-1406 demo fixtures: three German XRechnung-shaped CommercialDocuments.
...
def _meta(name: str) -> dict[str, Any]:
    return {"tenant_id": "tenant-demo-fastapi", "trace_id": f"trace-fastapi-{name}"}


FIXTURES: dict[str, dict[str, Any]] = {
    "basic": {
        "schema_version": "1.0",
        "id": "doc-de-fastapi-basic-2026-0001",
        "document_type": "invoice",
        "issue_date": "2026-05-27",
        "due_date": "2026-06-26",
        "document_number": "RE-FA-2026-0001",
        "currency": "EUR",
        "supplier": _SELLER,
        "customer": _BUYER,
    ...
    "with-allowance": {
        "schema_version": "1.0",
        "id": "doc-de-fastapi-allowance-2026-0002",
        "document_type": "invoice",
        "issue_date": "2026-05-27",
        "due_date": "2026-06-26",
        "document_number": "RE-FA-2026-0002",
        "currency": "EUR",
        "supplier": _SELLER,
        "customer": _BUYER,
        "payment_instructions": [],
    ...
    "reverse-charge": {
        "schema_version": "1.0",
        "id": "doc-de-fastapi-rc-2026-0003",
        "document_type": "invoice",
        "issue_date": "2026-05-27",
        "due_date": "2026-06-26",
        "document_number": "RE-FA-2026-0003",
        "currency": "EUR",
        "supplier": _SELLER,
        "customer": {
            **_BUYER,
